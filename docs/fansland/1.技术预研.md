...
可以参考GET Protocol的设计API模式，支持插件式（非侵入式）对接：

- https://docs.get-protocol.io/reference/concepts-overview
...
参考： https://docs.get-protocol.io/reference/concepts-actions

![](../imgs/nft_ticket_state_transformation.jpeg)