...
- 是否会限制NFT相关业务以及后续业务功能？
  ...
  - 接入加密货币支付（Crypto Concurrency）
    - 会有影响当前的IDR Wallet。
      - Cryptocurrency能换成IDR？  <font color=red> **xendit需要再仔细考虑!!!** </font>
      - 不提供IDR和Crypto转换
...
一级市场：
  ...
  - 渠道限制：
    - 加密货币：
      ...
      - bank transfer (BCA)
    - NFT: 限制可能会比cryptoconcurrency宽松一些
  - 钱包充值（余额存放在xendit）
...
是讲一个纯web3的故事？还是讲一个NFT票务+粉丝元宇宙的故事？

- 取决心态，如果想快速赚钱，NFT的故事是最快的；如果求稳定，传统+NFT，需要沉淀
- 纯web3的故事，如何吸引传统粉丝，需要解决冷启动的问题；
- 白皮书、token、NFT这些东西对于普通粉丝，有认知门槛，确认信任；
- 纯web3的故事，可以对资本方将； 对实际粉丝，要讲门票、粉丝经济的故事
- 区块链最大的作用就是融资，资本、用户
- 认真做事，不一定成功；融到资，就一定不会那么快死
- 把事情做到最大，不要局限于眼前
...
- 愿景要大，美元基金、外资需要听新故事
- 把brain当作合作伙伴，
- iMe可以解决冷启动的问题，一开始量小，但不是完全0启动
- BTS年底的展览，
- BTS虚拟展，需要解决授权的问题。


- 以iMe的名义发行 passcard NFT
- 逐步积累用户，通过音乐节验证产品，获得原始用户
